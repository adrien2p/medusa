...
export class draftOrders1613384784316 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "order" ADD "draft_order_id" character varying`
    );
    await queryRunner.query(
      `ALTER TABLE "order" ADD CONSTRAINT "UQ_727b872f86c7378474a8fa46147" UNIQUE ("draft_order_id")`
    );
    await queryRunner.query(
      `ALTER TYPE "public"."cart_type_enum" RENAME TO "cart_type_enum_old"`
    );
    await queryRunner.query(
      `CREATE TYPE "cart_type_enum" AS ENUM('default', 'swap', 'draft_order', 'payment_link')`
    );
    await queryRunner.query(
      `ALTER TABLE "cart" ALTER COLUMN "type" DROP DEFAULT`
    );
    await queryRunner.query(
      `ALTER TABLE "cart" ALTER COLUMN "type" TYPE "cart_type_enum" USING "type"::"text"::"cart_type_enum"`
    );
    await queryRunner.query(
      `ALTER TABLE "cart" ALTER COLUMN "type" SET DEFAULT 'default'`
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "store" ADD "payment_link_template" character varying`
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "order" DROP CONSTRAINT "FK_727b872f86c7378474a8fa46147"`
    );
    await queryRunner.query(
      `ALTER TABLE "draft_order" DROP CONSTRAINT "FK_8f6dd6c49202f1466ebf21e77da"`
    );
    await queryRunner.query(
      `ALTER TABLE "draft_order" DROP CONSTRAINT "FK_5bd11d0e2a9628128e2c26fd0a6"`
    );
    await queryRunner.query(`COMMENT ON COLUMN "cart"."type" IS NULL`);
    await queryRunner.query(
      `CREATE TYPE "cart_type_enum_old" AS ENUM('default', 'swap', 'payment_link')`
    );
    await queryRunner.query(
      `ALTER TABLE "cart" ALTER COLUMN "type" DROP DEFAULT`
    );
    await queryRunner.query(
      `ALTER TABLE "cart" ALTER COLUMN "type" TYPE "cart_type_enum_old" USING "type"::"text"::"cart_type_enum_old"`
    );
    await queryRunner.query(
      `ALTER TABLE "cart" ALTER COLUMN "type" SET DEFAULT 'default'`
    );
    ...
    await queryRunner.query(
      `ALTER TYPE "cart_type_enum_old" RENAME TO  "cart_type_enum"`
    );
    await queryRunner.query(
      `ALTER TABLE "order" DROP CONSTRAINT "UQ_727b872f86c7378474a8fa46147"`
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "store" DROP COLUMN "payment_link_template"`
    );
    await queryRunner.query(
